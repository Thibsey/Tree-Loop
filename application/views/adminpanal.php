...
<td>
    ...
    <div id="list-example" >
  <a class="btn btn-outline-secondary" href="#list-item-1">Overview</a><br><br>
  <a class="btn btn-outline-secondary" href="#list-item-2">User verification</a><br><br>
  <a class="btn btn-outline-secondary" href="#list-item-3">Post verification</a><br><br>
  <a class="btn btn-outline-secondary" href="#list-item-4">User managment</a><br><br>
</div>
</td>
<td>
<div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example" id="scrollit">
  <h4 id="list-item-1">Overview</h4>
  <p>#fh5co-services-section,
        #fh5co-blog-section,
        #fh5co-client-section,
        #fh5co-work-section,
        #fh5co-main-services-section,
  ...
  <h4 id="list-item-2">User verification</h4>
  <p>#fh5co-services-section,
        #fh5co-blog-section,
        #fh5co-client-section,
        #fh5co-work-section,
  ...
  <h4 id="list-item-3">Post verification</h4>
  <p>#fh5co-services-section,
        #fh5co-blog-section,
        #fh5co-client-section,
        #fh5co-work-section,
        #fh5co-main-services-section,
        #fh5co-about-section,
        #fh5co-contact-section </p>
  <h4 id="list-item-4">User managment</h4>
  <p>#fh5co-services-section,
        #fh5co-blog-section,
        #fh5co-client-section,
        #fh5co-work-section,
